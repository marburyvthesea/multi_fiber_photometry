function [DAQ_times, trigger_times, outputStatus] = photometryAcquisitionDAQinterleaved_disklogging_cycletime(inputCam, frames, pdir, inputCamGain, inputCamExposure)
...
src.Gain = inputCamGain; 
src.Exposure = inputCamExposure;
